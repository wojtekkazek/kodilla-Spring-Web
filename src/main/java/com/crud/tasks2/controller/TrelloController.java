...
public class TrelloController {
    ...
    public void getTrelloBoards() throws ListNotFoundException {

        List<TrelloBoardDto> trelloBoards = trelloClient.getTrelloBoards().orElseThrow(ListNotFoundException::new);
